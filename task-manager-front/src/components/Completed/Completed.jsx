...
import {selectCompleted} from "../../redux/state-slice/task-slice";
...
const Completed = () => {
    ...
    useEffect(()=>{
        ...
        selectTaskByStatusRequest("Completed");

    },[]);



    const CompletedTaskList = useSelector(selectCompleted);


    const UpdateTask = (id) => {

         TaskUpdateAlert(id,"Completed");
    }
                              ...
                              <div className="card h-100">
                                  <div className="card-body">
                                    ...
                                    <p className="m-0 animated fadeInUp p-0">
                                        ...
                                        <a onClick={()=>{TaskDeleteAlert(item._id, "Completed")}} className="icon-nav text-danger mx-1"><AiOutlineDelete/></a>
