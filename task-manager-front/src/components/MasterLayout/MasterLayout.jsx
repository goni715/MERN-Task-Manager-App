...
import {AiOutlineCheckCircle, AiOutlineEdit, AiOutlineUser} from "react-icons/ai";
        ...
        <Fragment>
            ...
            <Navbar  className="fixed-top px-0 shadow-sm ">
                <Container fluid={true}>
                    <Navbar.Brand >
                        <a className="icon-nav m-0 h5" onClick={MenuBarClickHandler}><RiIndentDecrease/></a>
                        ...
                        <div className="user-dropdown">
                            ...
                            <div className="user-dropdown-content ">
                                ...
                                <a onClick={onLogout}  className="side-bar-item">
                                    <HiOutlineLogout className="side-bar-item-icon"/>
