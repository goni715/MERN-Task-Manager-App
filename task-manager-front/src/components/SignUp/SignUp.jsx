...
import {SignUpRequest, SignUpVerifyEmailRequest} from "../../APIServices/CRUDServices";
...
import {setFirstName, setLastName, setMobile, setPassword, setPhoto, setRegEmail} from "../../helper/SessionHelper";
...
const Registration = (props) => {
    ...
    const onRegistration = () => {
        ...
        if(IsEmpty(email)) {
            ...
            SignUpVerifyEmailRequest(email).then((result)=>{
                            ...
                            <div className="card-body">
                                ...
                                <div className="container-fluid m-0 p-0">
                                    <div className="row m-0 p-0">
                                        ...
                                        <div className="col-md-4 p-2">
                                            <input ref={(input)=>firstNameRef=input} placeholder="First Name" className="form-control animated fadeInUp formInput" type="text"/>
                                        </div>
                                        <div className="col-md-4 p-2">
                                            <input ref={(input)=>lastNameRef=input} placeholder="Last Name" className="form-control animated fadeInUp formInput" type="text"/>
                                        </div>
                                        <div className="col-md-4 p-2">
                                            <input ref={(input)=>mobileRef=input} placeholder="Mobile" className="form-control animated fadeInUp formInput" type="mobile"/>
                                        </div>
                                    ...
                                    <div className="row mt-2 p-0">
                                        <div className="col-md-4 p-2">
                                            <button onClick={onRegistration} className="btn mt-3 w-100 float-end btnBackground animated fadeInUp">Sign Up</button>
                                        </div>
                                    </div>
                                </div>
